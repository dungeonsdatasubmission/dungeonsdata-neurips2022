...
singularity exec --nv -H /home/z1188643/dungeonsdata-neurips2022/experiment_code --env WANDB_API_KEY=d2f9309c1cee36dc7ad726c57e4eba04974d9914 --env WANDBPWD=$PWD -B /shared/results/z1188643/dungeons/nle:/nle -B $TMPDIR:/tmp /shared/results/z1188643/dungeons/dungeons.sif ./train.sh

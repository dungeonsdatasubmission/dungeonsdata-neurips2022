...
params_grid = [
    {
        ...
        "model_checkpoint_path": ["/net/tscratch/people/plgbartekcupial/mrunner_scratch/nle/10_05-09_22-awesome_heisenberg/monk-aa-bc-deep_hp0i_0/checkpoint/hackrl/nle/monk-AA-BC_deep_0/checkpoint.tar"],
        # log forgetting
        "log_forgetting": [True],

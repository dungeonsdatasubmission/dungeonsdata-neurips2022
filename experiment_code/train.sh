...
# python -m hackrl.experiment connect=$BROKER_IP:$BROKER_PORT model=DecisionTransformer exp_set=2G exp_point=@-AA-DT num_actor_cpus=20 total_steps=2_000_000_000 actor_batch_size=256 batch_size=128 ttyrec_batch_size=512 supervised_loss=1 adam_learning_rate=0.001 behavioural_clone=True group='@-AA-DT'
# python -m hackrl.experiment connect=$BROKER_IP:$BROKER_PORT model=DecisionTransformer exp_set=2G exp_point=monk-AA-DT num_actor_cpus=20 total_steps=2_000_000_000 actor_batch_size=256 batch_size=128 ttyrec_batch_size=512 supervised_loss=1 adam_learning_rate=0.001 behavioural_clone=True character='mon-hum-neu-mal' group='monk-AA-DT'
# python -m hackrl.experiment connect=$BROKER_IP:$BROKER_PORT model=DecisionTransformer exp_set=2G  exp_point=@-NAO-DT num_actor_cpus=20 total_steps=2_000_000_000 actor_batch_size=256 batch_size=128 ttyrec_batch_size=512 supervised_loss=1 adam_learning_rate=0.001 behavioural_clone=True dataset=nld-nao dataset_bootstrap_actions=True bootstrap_pred_max=True  dataset_bootstrap_path=/path/to/checkpoint.tar group='@-NAO-DT'
